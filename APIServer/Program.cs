...
builder.Services.AddSingleton<XmlValidator>(new XmlValidator("Schemas\\schema.xsd"));
builder.Services.AddSingleton<ICustomValidator>(new CustomValidator("Schemas\\truckSchema.rng"));
